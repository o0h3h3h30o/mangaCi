...
<div class="container profile-content">
  ...
  <div style="padding:12px 16px;margin-bottom:16px;background:rgba(232,64,87,.1);border:1px solid rgba(232,64,87,.3);border-radius:8px;font-size:13px;color:var(--accent-red)"><?= esc($msg) ?></div>
  <?php endif; ?>

        ...
        <div class="flex items-center justify-center">
          <a href="/">
            <div class="flex-shrink-0 flex items-center">
              ...
              <img class="block lg:hidden w-auto ml-12 sm:ml-0 object-contain"
                src="<?= esc($_dlogo) ?>" alt="<?= $_dalt ?>"
                style="max-height:48px;max-width:300px;margin-left:35px;">
              <img class="hidden lg:block w-auto object-contain"
                src="<?= esc($_dlogo) ?>" alt="<?= $_dalt ?>"
                style="max-height:56px;max-width:300px;margin-left:-30px;">
